...
export const refreshDiscussions = state =>
  fromDiscussions.refreshDiscussions(state.discussions)
export const refreshComments = state =>
  fromDiscussions.refreshComments(state.discussions)
export const getSingleComment = (state, id) =>
  fromDiscussions.getSingleComment(state.discussions, id)
