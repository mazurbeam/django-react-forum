...
// ForumList
export const FETCHING_FORUMLIST_REQUEST = '@@discussions/REQUEST_FORUMLIST_REQUEST';
export const FETCHING_FORUMLIST_SUCCESS = '@@discussions/REQUEST_FORUMLIST_SUCCESS';
export const FETCHING_FORUMLIST_FAILURE = '@@discussions/REQUEST_FORUMLIST_FAILURE';

// Discussions
export const FETCHING_DISCUSSIONS_REQUEST = '@@discussions/REQUEST_DISCUSSIONS_REQUEST';
export const FETCHING_DISCUSSIONS_SUCCESS = '@@discussions/REQUEST_DISCUSSIONS_SUCCESS';
export const FETCHING_DISCUSSIONS_FAILURE = '@@discussions/REQUEST_DISCUSSIONS_FAILURE';

export const CREATE_DISCUSSION_REQUEST = '@@discussions/CREATE_DISCUSSION_REQUEST';
export const CREATE_DISCUSSION_SUCCESS = '@@discussions/CREATE_DISCUSSION_SUCCESS';
export const CREATE_DISCUSSION_FAILURE = '@@discussions/CREATE_DISCUSSION_FAILURE';

// Discussion Comments GET
export const FETCHING_DISCUSSION_COMMENTS_REQUEST = '@@discussions/REQUEST_DISCUSSION_COMMENTS_REQUEST';
export const FETCHING_DISCUSSION_COMMENTS_SUCCESS = '@@discussions/REQUEST_DISCUSSION_COMMENTS_SUCCESS';
export const FETCHING_DISCUSSION_COMMENTS_FAILURE = '@@discussions/REQUEST_DISCUSSION_COMMENTS_FAILURE';
...
export const fetchForumList = () => ({
  [RSAA]: {
    ...
    types: [FETCHING_FORUMLIST_REQUEST, FETCHING_FORUMLIST_SUCCESS, FETCHING_FORUMLIST_FAILURE]
  }
});
...
export const fetchDiscussions = () => ({
  [RSAA]: {
    ...
    method: 'GET',
    headers: withAuth({ 'Content-Type': 'application/json' }),
    types: [FETCHING_DISCUSSIONS_REQUEST, FETCHING_DISCUSSIONS_SUCCESS, FETCHING_DISCUSSIONS_FAILURE]
  }
});

export const createDiscussion = (forum, user, title, content, pinned = false) => ({
  [RSAA]: {
    ...
    headers: withAuth({ 'Content-Type': 'application/json' }),
    types: [CREATE_DISCUSSION_REQUEST, CREATE_DISCUSSION_SUCCESS, CREATE_DISCUSSION_FAILURE]
  }
});
